...
export function Compare() {
  ...
  return (
    <div className="w-full bg-[#050505] selection:bg-blue-500/30 relative pb-20">
      <div className="p-4 md:p-6 lg:p-10 pt-4 md:pt-6 pb-40">
        ...
        >
          <div className="flex flex-col items-center justify-center text-center mb-10 md:mb-16 gap-3 md:gap-4 px-4">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[9px] md:text-[10px] font-bold uppercase tracking-widest mx-auto">
              Video showdown
            </div>
            <h1 className="text-3xl md:text-5xl font-bold tracking-tight font-serif italic text-white leading-tight">Face-off analysis</h1>
            <p className="text-gray-400 max-w-lg text-[13px] md:text-base leading-relaxed px-4 md:px-0">
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="lg:col-span-12 space-y-8">
              <div className="flex flex-col md:flex-row gap-8 items-center justify-center max-w-4xl mx-auto">
                {/* Video 1 */}
                <div className="flex-1 w-full bg-[#0f1115] border border-white/5 rounded-[1.25rem] md:rounded-[2rem] p-5 md:p-8 relative hover:border-blue-500/30 transition-colors shadow-xl">
                  <div className="flex items-center justify-between mb-4 md:mb-6">
                    <div className="flex items-center gap-3 md:gap-4">
                      <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-blue-600/10 text-blue-400 flex items-center justify-center text-[10px] md:text-xs font-bold border border-blue-500/20">1</div>
                      <h3 className="font-semibold text-xs md:text-base text-gray-300">Target video A</h3>
                    </div>
                  </div>
                  <div className="relative flex items-center bg-black/60 border border-white/5 rounded-xl md:rounded-2xl p-1.5 focus-within:border-blue-500/50 transition-all">
                ...
                {/* Video 2 */}
                <div className="flex-1 w-full bg-[#0f1115] border border-white/5 rounded-[1.25rem] md:rounded-[2rem] p-5 md:p-8 relative hover:border-purple-500/30 transition-colors shadow-xl">
                  <div className="flex items-center justify-between mb-4 md:mb-6">
                    <div className="flex items-center gap-3 md:gap-4">
                      <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-purple-600/10 text-purple-400 flex items-center justify-center text-[10px] md:text-xs font-bold border border-purple-500/20">2</div>
                      <h3 className="font-semibold text-xs md:text-base text-gray-300">Target video B</h3>
                    </div>
                  </div>
                  <div className="relative flex items-center bg-black/60 border border-white/5 rounded-xl md:rounded-2xl p-1.5 focus-within:border-purple-500/50 transition-all">
                    <div className="pl-4 pr-3 text-gray-600">
                      <Link2 className="w-5 h-5" />
                    </div>
                    <input
              ...
              <button
                ...
                className={cn(
                  "w-full py-4 md:py-5 rounded-xl md:rounded-2xl font-bold text-[11px] md:text-sm uppercase tracking-widest flex items-center justify-center gap-3 transition-all px-6 md:px-8",
